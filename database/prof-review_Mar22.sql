...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 21, 2025 at 05:46 PM
...
CREATE TABLE IF NOT EXISTS `book_tag` (
  ...
  `book_tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(116, 14, 'Fiction', '2025-03-21 07:47:23', '2025-03-21 07:47:23'),
(117, 14, 'Mystery', '2025-03-21 07:47:23', '2025-03-21 07:47:23'),
(118, 14, 'Featured Review', '2025-03-21 07:47:23', '2025-03-21 07:47:23');
...
(9, 'ssss', 'simon@gmail.com', '3453453', 'test test without honeypot', '2025-03-20 02:49:13', '2025-03-20 02:49:13'),
(10, 'erer', 'simontrtrtt@gmail.com', '3984938439447', 'test with honeypot', '2025-03-20 02:51:52', '2025-03-20 02:51:52'),
(11, 'Test Name', 'simontestttt@gmail.com', '+102938474484', 'hehehehehehee', '2025-03-20 03:11:30', '2025-03-20 03:11:30');
...
DROP TABLE IF EXISTS `featured_author`;
...
(31, '2025_03_19_125829_create_featured_author_table', 12);
...
CREATE TABLE IF NOT EXISTS `reviews` (
  ...
  `review_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
