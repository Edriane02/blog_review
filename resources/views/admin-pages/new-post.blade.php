                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <div class="alert alert-info" role="alert">
                                        <strong><i class="bi bi-info-circle"></i>&nbsp;&nbsp;Recommended image size in pixels:</strong> 1000x600
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="pages" class="form-control" id="bookPages" placeholder="" required>
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="mb-4">
                                            <label for="bookGenre" class="form-label">Genre</label> <span>(e.g. Fiction, Mystery, ...)</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="text-muted"><i>Leave blank if unavailable.</i></p>
                                        <input class="form-control" name="amazon_link" type="text" value="" placeholder="https://www.amazon.com..." id="amazon-s-link">
                                    </div>

                                    <div class="mb-3">
                                        <label for="barnes-s-link">Barnes & Noble Link</label>
                                        <p class="text-muted"><i>Leave blank if unavailable.</i></p>
                                        <input class="form-control" name="barnes_noble_link" type="text" value="" placeholder="https://www.barnesandnoble.com..." id="barnes-s-link">
                                    </div>
                                </div>
                                <br />
                                <div>
