...
<main>
    <div class="archive-header pt-50">
        <div class="container">
            <h2 class="font-weight-900">Featured Authors</h2>
                        ...
                        <div class="loop-list loop-list-style-1">
                            @if($featuredAuthors->count() > 0)
                                @foreach($featuredAuthors as $featuredAuthor)
                                    @if($featuredAuthor->status !== 'Hidden')
                                            ...
                                            <div class="row mb-40 list-style-2">
                                                ...
                                                <div class="col-md-8 align-self-center">
                                                    <div class="post-content">
                                                        ...
                                                        <p style="color: #696969; font-style: italic; margin-bottom: 3px;"><b>{{ $featuredAuthor->headline }}</b></p>
                                                        <div class="text-muted">
                                                            {!! \Illuminate\Support\Str::limit($featuredAuthor->body_text, 250) !!}
                                                        </div>
                                                        <div class="mb-3">
                                                        <a href="{{ route('featured.author', $featuredAuthor->id) }}" 
                                                           class="btn btn-sm btn-info" style="font-size: 12px;">Read more&nbsp;&nbsp;<i class="bi bi-arrow-right"></i></a>
                                                        </div>
                            ...
                            @else
                                <div class="alert alert-info" role="alert"><h6><i class="bi bi-emoji-frown"></i>&nbsp;&nbsp;No featured authors yet.</h6></div>
                                <br /><br /><br />
                            @endif
                        </div>
                    </div>
