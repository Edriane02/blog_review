...
<main class="bg-grey pt-80 pb-50">
        <div class="container">
            <div class="row pt-80">
                <div class="col-lg-6 col-md-12 d-lg-block d-none pr-50"><img class="img-filter-brown" src="{{ asset('guestAssets/imgs/static/maintenance-ui-comp.png') }}" alt="" width="360"></div>
                <div class="col-lg-6 col-md-12 pl-50 text-md-center text-lg-left">
                    <h2 style="font-size: 40px;!important" class="mb-30 fancy-font page-404">Coming soon!</h2>
